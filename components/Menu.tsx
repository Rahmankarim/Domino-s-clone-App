...
import productsData from '../Data/productData.json'; // Import JSON data
...
interface MenuProps {
  navigation: NavigationProp<any>; // Use correct type based on your navigation setup
}
...
const Menu: React.FC<MenuProps> = ({ navigation }) => {
  ...
  // Add the navigateToItemPage function here
  ...
  const renderProduct = ({ item }: { item: Product }) => (
    <TouchableOpacity
      ...
      onPress={() => navigateToItemPage(item)} // Call navigateToItemPage when a product is clicked
    >
